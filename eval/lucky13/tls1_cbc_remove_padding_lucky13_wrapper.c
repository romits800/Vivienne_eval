...
int tls1_cbc_remove_padding_lucky13_wrapper(long s3_flags, unsigned long flags, \
					    unsigned long options,	\
					    int slicing_cheat, unsigned int block_size, \
					    unsigned int mac_size, unsigned char data[], \
					    unsigned int length ) {
