...
;; (public (i32.const 0) (i32.const 39999) (i32.const 0)) ;; mainly initialized memory
 ...
 (secret (i32.const 40040) (i32.const 41063)) ;; c 40040 - 40040 + mlen
 (secret (i32.const 41064) (i32.const 41127)) ;; clen_p 41064 - 41128
 (secret (i32.const 41128) (i32.const 42151)) ;; m 41128 - 42152
