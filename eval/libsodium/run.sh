...
do
    ...
    ../../relsymb/interpreter/wasm imports_aead.wast aead_O$i.wast  -t -i script_aead.wast
    ../../relsymb/interpreter/wasm imports_auth.wast auth_O$i.wast  -t -i script_auth.wast
    ../../relsymb/interpreter/wasm imports_chacha20.wast chacha20_O$i.wast  -t -i script_chacha20.wast
    ../../relsymb/interpreter/wasm imports_poly1305.wast poly1305_O$i.wast  -t -i script_poly1305.wast
    ../../relsymb/interpreter/wasm imports_salsa20.wast salsa20_O$i.wast  -t -i script_salsa20.wast
    ../../relsymb/interpreter/wasm imports_sha256.wast sha256_O$i.wast  -t -i script_sha256.wast
    ../../relsymb/interpreter/wasm imports_sha512.wast sha512_O$i.wast  -t -i script_sha512.wast
done
