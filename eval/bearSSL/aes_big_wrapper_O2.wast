(module
  ...
  (func $br_aes_keysched (type 1) (param i32 i32 i32) (result i32)
    ...
    local.get 3)
  (func $br_aes_big_encrypt (type 2) (param i32 i32 i32)
    ...
    i32.shr_u
    i32.store8)
  (func $br_aes_big_cbcenc_init (type 2) (param i32 i32 i32)
    local.get 0
    i32.const 2352
    i32.store
    local.get 0
  ...
  (func $br_aes_big_cbcenc_run (type 3) (param i32 i32 i32 i32)
    (local i32 i32 i32)
    block  ;; label = @1
      local.get 3
      i32.eqz
