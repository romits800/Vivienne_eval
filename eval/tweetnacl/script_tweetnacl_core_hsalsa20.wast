(module $js 
	...
	(secret (i32.const 1972) (i32.const 2051))
   )
(register "js" $js)
...
;; output + nonc + key + "expand 32-byte k"
(symb_exec "core_hsalsa20" (i32.sconst 1972) (i32.sconst 2004) (i32.sconst 2020) (i32.sconst 1952))
