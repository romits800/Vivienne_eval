(module $js 
	...
	(public (i32.const 1952) (i32.const 1971))
	(secret (i32.const 1972) (i32.const 2035))
	(secret (i32.const 2036) (i32.const 2083))
   )
(register "js" $js)
...
(symb_exec "core_salsa20" (i32.sconst 1972) (i32.sconst 2036) (i32.sconst 2052) (i32.sconst 1952))
